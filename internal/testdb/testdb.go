...
func NewClickHouse(options ...OptionsFunc) (db *sqlx.DB, cleanup func(), err error) {
...
func NewPostgres(options ...OptionsFunc) (db *sqlx.DB, cleanup func(), err error) {
...
func NewMariaDB(options ...OptionsFunc) (db *sqlx.DB, cleanup func(), err error) {
